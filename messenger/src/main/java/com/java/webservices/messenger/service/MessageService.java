...
import com.java.webservices.messenger.exception.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService(){
		messages.put(1L, new Message(1,"Hello world","Anita"));
		messages.put(2L, new Message(2,"Welcome","Sumanth"));
